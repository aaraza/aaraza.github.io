...
draft = false
title = "Retro Gaming on MacOS"
+++

## Setup

#### Atari 2600, NES, SNES, Gameboy, N64, and Sega Genesis
1. Download and install [OpenEmu](https://openemu.org).
2. Download a curated rom set. I used [Tiny Best Set: Go!](https://archive.org/details/tiny-best-set-go).

#### PS2
1. Download and install [PCSX2](https://pcsx2.net).
2. Download a PS2 [bios](https://emulation.gametechwiki.com/index.php/Emulator_files#PlayStation_2) and add it to PCSX2.
3. Download roms from [RomsFun.com](https://romsfun.com/roms/playstation-2/).

## Thoughts

Windows is the de facto operating system for desktop and laptop computers. Its dominant market share, 70% globally, essentially necessitates that developers build for Windows. Apple's macOS is the most successful challenger - its 15% market share (30% in the US) quadrupled in the 2010s. Apple successfully marketed Macs as the up-scale personal computing option, and they became very popular amongst college students, creatives, and developers.
